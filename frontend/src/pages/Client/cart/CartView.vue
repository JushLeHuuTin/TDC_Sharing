      ...
      <div class="grid grid-cols-12 gap-8">
        ...
        <div class="col-span-12 lg:col-span-4 sticky top-24 space-y-6">
          ...
          <div class="bg-white rounded-lg shadow-sm p-6 space-y-4">
            <h3 class="font-semibold text-gray-900">Phương thức thanh toán</h3>

            <div class="flex items-center p-3 border border-blue-600 bg-blue-50 rounded-lg cursor-pointer">
                <input type="radio" name="payment" id="cod" checked class="text-blue-600 mr-3">
                <label for="cod" class="flex-1">
                    <p class="font-medium text-gray-900">Thanh toán khi nhận hàng</p>
                    <p class="text-xs text-gray-500">Trả tiền mặt khi giao hàng</p>
                </label>
            </div>

            <div class="flex items-center p-3 border rounded-lg hover:bg-gray-50 cursor-pointer">
                <input type="radio" name="payment" id="bank" class="text-blue-600 mr-3">
                <label for="bank" class="flex-1">
                    <p class="font-medium text-gray-900">Chuyển khoản ngân hàng</p>
                    <p class="text-xs text-gray-500">Chuyển khoản trực tiếp</p>
                </label>
            </div>

            <div class="flex items-center p-3 border rounded-lg hover:bg-gray-50 cursor-pointer">
                <input type="radio" name="payment" id="momo" class="text-blue-600 mr-3">
                <label for="momo" class="flex-1">
                    <p class="font-medium text-gray-900">Ví MoMo</p>
          ...
          <div class="bg-white rounded-lg shadow-sm p-6 space-y-4">
            ...
            <div class="flex space-x-2">
                <input type="text" placeholder="Nhập mã giảm giá" class="flex-1 border border-gray-300 rounded-lg text-sm p-2.5 focus:border-blue-500 focus:ring-blue-500">
                <button class="bg-blue-600 text-white px-4 py-2 rounded-lg font-medium text-sm hover:bg-blue-700">
                    Áp dụng
                </button>
            </div>
            ...
            <div class="space-y-2 text-sm">
                <div class="flex items-center justify-between text-gray-700">
                    <p class="font-mono bg-green-100 text-green-700 px-2 py-0.5 rounded text-xs">STUDENT10 (-10%)</p>
                    <button class="text-blue-600 hover:text-blue-700">Chọn</button>
                </div>
                <div class="flex items-center justify-between text-gray-700">
                    <p class="font-mono bg-blue-100 text-blue-700 px-2 py-0.5 rounded text-xs">NEWBIE30 (-30k ship)</p>
                    <button class="text-blue-600 hover:text-blue-700">Chọn</button>
                </div>
            </div>
          </div>
