...
//     // ... (Giữ nguyên array data notifications) ...
//     return [
...
// Chức năng chuyển đổi icon class (dùng cho category items)
...
onMounted(() => {
    loadCategories(); // Tải categories data khi component được mount
});
