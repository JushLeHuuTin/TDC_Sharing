<footer class="bg-gray-800 text-white py-12 mt-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        <li><a href="#" class="hover:text-white">Sách giáo khoa</a></li>
                        <li><a href="#" class="hover:text-white">Đồ điện tử</a></li>
                        <li><a href="#" class="hover:text-white">Quần áo</a></li>
                        <li><a href="#" class="hover:text-white">Đồ dùng học tập</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        <li><a href="#" class="hover:text-white">Hướng dẫn mua bán</a></li>
    ...
    </footer><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/ChuyenDeWeb1/Lab2/php-docker-dev/source/TDC_Sharing/backend/resources/views/components/footer.blade.php ENDPATH**/ ?>